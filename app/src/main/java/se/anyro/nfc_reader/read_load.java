...
public class read_load extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_read_load);
        Log.d("qqqqqqqqq",getIntent().toString());
        ...
        if (mAdapter == null) {
            AlertDialog dlg = new AlertDialog.Builder(read_load.this).setTitle("Alert!!").setMessage("Device not support NFC.").setPositiveButton("OK", new DialogInterface.OnClickListener() {
                @Override
